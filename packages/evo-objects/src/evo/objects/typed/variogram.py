...
class Variogram(ConstructableObject[VariogramData]):
    ...
    def _repr_html_(self) -> str:
        ...
        # Build the variogram specific table
        ...
        if self.structures:
            ...
            html += f'<div style="margin-top: 8px;"><strong>Structures ({len(self.structures)}):</strong></div>{structures_table}'
