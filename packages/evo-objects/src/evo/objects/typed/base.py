...
class BaseObject(_BaseObject):
    ...
    def create(
        ...
        return object_type._create(evo_context, data, parent)
    ...
    async def replace(
        ...
        """
        object_type = cls._get_object_type_from_data(data)
        return await object_type._replace(evo_context, reference, data)
    ...
    async def create_or_replace(
        ...
        """
        object_type = cls._get_object_type_from_data(data)
        return await object_type._replace(evo_context, reference, data, create_if_missing=True)
...
class ConstructableObject(BaseObject, Generic[_T]):
    ...
    async def create(
        ...
        :param parent: Optional parent path for the object.
        """
        return await cls._create(evo_context, data, parent)
    ...
    async def replace(
        ...
        :param data: The data that will be used to create the object.
        """
        return await cls._replace(evo_context, reference, data)
    ...
    async def create_or_replace(
        ...
        :param data: The data that will be used to create the object.
        """
        return await cls._replace(evo_context, reference, data, create_if_missing=True)
