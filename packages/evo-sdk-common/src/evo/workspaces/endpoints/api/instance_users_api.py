...
class InstanceUsersApi:
    """API client for the Instance_Users endpoint.
    ...
    async def add_instance_users(
        ...
        return await self.connector.call_api(
            ...
            resource_path="/workspace/orgs/{org_id}/members/users",
    ...
    async def remove_instance_user(
        ...
        return await self.connector.call_api(
            method=RequestMethod.DELETE,
            resource_path="/workspace/orgs/{org_id}/members/users/{user_id}",
            path_params=_path_params,
            header_params=_header_params,
            collection_formats=_collection_formats,
            response_types_map=_response_types_map,
    ...
    async def remove_instance_user_deprecated(
        self,
        org_id: str,
        user_id: str,
        additional_headers: dict[str, str] | None = None,
